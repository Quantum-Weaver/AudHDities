// =====================================================
// FILE: app/api/acid_test_questions/route.ts
// GENERATED: 2026-04-06T00:00:37.911Z
// METHODS: GET_LIST, POST
// =====================================================

// =====================================================
// GET /api/acid_test_questions - List acid_test_questions
// =====================================================
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('acid_test_questions').select('*', { count: 'exact' });
...
// =====================================================
// POST /api/acid_test_questions - Create acid_test_questions
// =====================================================
...
import { AcidTestQuestionsInsertSchema } from '@/lib/validators/acid_test_questions';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AcidTestQuestionsInsertSchema.parse(body);
    ...
    console.error('Error creating acid_test_questions:', error);
    return errorResponse('Failed to create acid_test_questions', 500);
  }
}
