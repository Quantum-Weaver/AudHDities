...
-- Create unique partial indexes instead of constraints with WHERE
CREATE UNIQUE INDEX idx_unique_post_reaction 
ON reactions(user_id, post_id, reaction_type) 
WHERE post_id IS NOT NULL;

CREATE UNIQUE INDEX idx_unique_comment_reaction 
ON reactions(user_id, comment_id, reaction_type) 
WHERE comment_id IS NOT NULL;

CREATE UNIQUE INDEX idx_unique_reply_reaction 
ON reactions(user_id, reply_id, reaction_type) 
