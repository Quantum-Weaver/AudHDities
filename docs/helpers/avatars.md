...
### Avatar with Variant Ring
```tsx
<Avatar size="xl" variant="quantum" glow>
  <AvatarImage src="/avatar.jpg" alt="Quantum Weaver" />
  <AvatarFallback>QW</AvatarFallback>
</Avatar>
```

### Avatar with Badge (Verified)
```tsx
<Avatar size="lg">
...
### Interactive Avatar
```tsx
<InteractiveAvatar size="2xl" status="online" variant="quantum">
...
<AvatarGroup max={3} size="md">
  <Avatar><AvatarImage src="/user1.jpg" /><AvatarFallback>A</AvatarFallback></Avatar>
  <Avatar><AvatarImage src="/user2.jpg" /><AvatarFallback>B</AvatarFallback></Avatar>
  <Avatar><AvatarImage src="/user3.jpg" /><AvatarFallback>C</AvatarFallback></Avatar>
  <Avatar><AvatarImage src="/user4.jpg" /><AvatarFallback>D</AvatarFallback></Avatar>
  <Avatar><AvatarImage src="/user5.jpg" /><AvatarFallback>E</AvatarFallback></Avatar>
</AvatarGroup>
```
...
export const UserCard = React.forwardRef<HTMLDivElement, UserCardProps>(
  ({ avatar, name, role, onFollow, isFollowing = false, variant = 'glass' }, ref) => (
    <Card ref={ref} variant={variant} interactive padding="md" className="text-center">
      <Avatar size="xl" variant="quantum" className="mx-auto mb-3">
      ...
      <CardFooter className="justify-center mt-4 pt-0 border-t-0">
        {onFollow && (
...
|------|--------|----------|
| xs | 24px | Compact lists, badges |
| sm | 32px | Comments, small groups |
| default | 40px | Standard avatar |
| lg | 48px | Profile cards |
| xl | 56px | User profiles |
| 2xl | 64px | Hero sections |
| 3xl | 80px | Large displays |
| 4xl | 96px | Landing pages |

| Variant | Ring Color | Use Case |
|---------|------------|----------|
| default | `white/20` | Standard |
| quantum | `cyan-500/50` | Quantum Weavers |
| cosmic | `blue-500/50` | Cosmic entities |
| fire | `orange-500/50` | Hearth-Keeper |
| hearth | `amber-500/50` | Community members |
| sanctuary | `purple-500/50` | Council members |

| Status | Color | Use Case |
|--------|-------|----------|
| online | green-500 | Active user |
| offline | white/20 | Inactive |
| away | yellow-500 | Away/AFK |
| busy | red-500 | Do not disturb |
