...
A card component is a **contained content unit** that groups related information into a visually distinct surface. It is the **room** within the sanctuary—every product, every profile, every piece of content finds its home in a card.

**What it provides:**
- Consistent elevation and border styling
- Variants for different content types (default, elevated, glass, interactive)
...
<GlassCard padding="none" className="overflow-hidden">
  ...
  <CardBody className="p-6">
    <CardTitle>The Sovereign Sanctuary</CardTitle>
    <CardDescription>Where consciousness meets sovereignty</CardDescription>
  </CardBody>
</GlassCard>
```
...
<Grid cols={1} colsMd={2} colsLg={4} gap="md">
  <MetricCard title="Revenue" value="$12,345" icon={<DollarSign />} trend="up" trendValue="+12%" />
  <MetricCard title="Users" value="1,234" icon={<Users />} trend="up" trendValue="+5%" />
  <MetricCard title="Products" value="567" icon={<Package />} trend="neutral" />
  <MetricCard title="Quests" value="89" icon={<Target />} trend="up" trendValue="+8%" />
</Grid>
```
...
<Grid cols={1} colsMd={2} colsLg={3} gap="lg">
  {items.map(item => (
    <InteractiveCard key={item.id} padding="md">
...
### Outline Card for Form
```tsx
<OutlineCard padding="lg">
  <VStack space="md">
...
|---------|------------|--------|--------|----------|
| default | `white/5` | `white/10` | none | Standard content |
| elevated | `white/5` | `white/10` | `shadow-lg` | Important content |
| glass | `white/5` | `white/20` | none + blur | Modern/immersive |
| outline | transparent | `white/10` | none | Subtle grouping |
| ghost | transparent | none | none | Minimal grouping |

| Padding | Value | Use Case |
|---------|-------|----------|
| none | 0px | Image-only cards |
...
| md | 6px | Default |
| lg | 8px | Soft cards |
| xl | 12px | Rounded cards |
| 2xl | 16px | Modern cards |
