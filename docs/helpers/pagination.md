...
A pagination component is a **navigation system** that divides large datasets into manageable pages. It is the **bookmark** of the interface—every product list, every search result, every activity log needs pagination.

**What it provides:**
- Page number navigation with ellipsis for large ranges
- Previous/next buttons
- First/last page shortcuts
- Configurable sibling count (how many pages to show around current)
...
|------|-------------|----------|
| sm | 28px | Dense tables |
| md | 32px | Default |
| lg | 36px | Touch-friendly |

| Variant | Style | Use Case |
|---------|-------|----------|
| default | Filled background | Standard |
| outline | Bordered | Subtle |
| minimal | Text only | Compact spaces |

| Feature | Use Case |
|---------|----------|
| First/Last | Many pages (100+) |
| Page size selector | User preference |
