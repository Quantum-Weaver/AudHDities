...
## Welcome to AUDHDITIES

By accessing or using AUDHDITIES ("the Platform"), you agree to be bound by these Terms of Service ("Terms"). Please read them carefully.
...
- **Community**: We prioritize mutual aid and collective flourishing over extraction

## 2. User Accounts

### 2.1 Eligibility
You must be at least 13 years old to use the Platform. Users under 18 must have parental consent.
...
We believe neurodivergence is not a disorder but a different operating system. Our platform is designed to:

- Reduce cognitive load through optional focus modes
...
### 4.1 Pricing Tiers
- **Community Tier**: Subsidized access for neurodivergent users (determined by Acid Test)
- **Ally Tier**: Standard pricing for supporters
...
- Content that exploits or harms others
...
### 6.1 Be Respectful
We welcome diverse perspectives but require respectful communication.

### 6.2 No Exploitation
The Platform is designed to prevent exploitation. Users who attempt to game the system may be suspended.

### 6.3 Mutual Aid
We encourage community members to support each other within their capacity.
...
### 8.2 License to Platform
By posting content, you grant AUDHDITIES a license to display and distribute your content on the Platform.

### 8.3 Platform IP
The AUDHDITIES name, logo, and brand elements are our intellectual property.
...
To the maximum extent permitted by law, AUDHDITIES shall not be liable for any indirect, incidental, or consequential damages.
...
*These Terms of Service are designed to be fair, transparent, and aligned with our values. If you have suggestions for improvement, please let us know.*