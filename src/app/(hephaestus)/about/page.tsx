      ...
      <main className="min-h-screen">
        ...
        <section className="container max-w-6xl mx-auto px-6 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            />
            <ValueCardRenderer
              data={{ id: 'no-exploit', type: 'value', title: 'No Exploitation', value: 'Safety', description: 'We do not farm vessels for profit. Patrons are vetted. Bigotry is taxed. Transparency is absolute.' }}
              radius="lg"
              shadow="md"
            />
            <ValueCardRenderer
