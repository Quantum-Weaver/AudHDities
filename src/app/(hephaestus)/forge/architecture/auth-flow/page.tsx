    ...
    <Page showForeground={false} showContinuityBeam={true}>
      <main className="min-h-screen">
        ...
        <div className="container max-w-4xl mx-auto px-6 pb-20 space-y-16">
          ...
          {/* Overview */}
          <Card 
            data={{ id: 'auth-overview', type: 'value', title: 'Overview', value: 'Magic Links' }}
            variant="glass"
            radius="lg"
            shadow="md"
            className="p-8"
          >
            ...
            <p className="text-star-dust/70 leading-relaxed">
              We use Supabase Auth with <strong className="text-neurospark">magic link emails</strong>. 
            ...
            <div className="space-y-8">
              ...
              >
                <p className="text-star-dust/40 text-sm mt-2">
                  ...
                  <code className="bg-white/5 px-2 py-0.5 rounded text-neurospark">app/(auth)/signup/page.tsx</code>
                </p>
              </StepCard>
          ...
          {/* Middleware */}
          <div>
            <h2 className="text-2xl font-bold text-star-dust mb-4">Middleware Protection</h2>
            <p className="text-star-dust/60 mb-4">
          ...
          {/* Why Magic Links */}
          <Card 
            data={{ id: 'auth-magic-links', type: 'value', title: 'Magic Links', value: 'Why' }}
            variant="ghost"
            radius="lg"
            shadow="md"
            className="p-6"
          >
            <h3 className="text-lg font-bold text-star-dust mb-3">✨ Why Magic Links?</h3>
