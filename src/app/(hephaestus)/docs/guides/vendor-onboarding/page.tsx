        ...
        <div className="container max-w-4xl mx-auto px-6 pb-20">
          ...
          <div className="mb-12 text-center">
            ...
            <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 rounded-full">
              <span className="text-cyan-400 text-sm">Platform fee fixed at 10%</span>
          ...
          <div className="mt-12">
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 via-transparent to-purple-500/10 border border-white/10 rounded-xl p-6 mb-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-cyan-400 font-bold mb-2">Platform Fee: 10%</h3>
                  <p className="text-white/60 text-sm">Fixed rate (industry standard is 30-50%). Covers hosting, development, and support.</p>
                </div>
                <div>
                  <h3 className="text-purple-400 font-bold mb-2">Your Share: 90%</h3>
                  <p className="text-white/60 text-sm">You keep 90% of every sale. Paid immediately via Stripe.</p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <h4 className="text-white font-bold">Covenant Pledge</h4>
                <p className="text-white/60 text-sm">Set your voluntary community contribution</p>
              </div>
              <div className="bg-white/5 rounded-lg p-4">
                <TrendingUp size={20} className="text-purple-400 mb-2" />
                <h4 className="text-white font-bold">Residual Settings</h4>
                <p className="text-white/60 text-sm">Set contributor share per product</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 rounded-lg p-4">
                <h4 className="text-white font-bold">❤️ Consider covenant pledge</h4>
                <p className="text-white/60 text-sm">Support community dignity—voluntary and appreciated</p>
              </div>
            </div>
          </div>
