          ...
          <section className='section-gradient'>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="p-6 text-center bg-cyan-500/5 border-cyan-500/20">
                ...
                <p className="text-star-dust/60 text-sm">Fixed, transparent, industry-low. Covers operations, development, and support.</p>
              </Card>
              ...
              <Card className="p-6 text-center bg-green-500/5 border-green-500/20">
                ...
                <p className="text-star-dust/60 text-sm">Voluntary pledge (0-50% of earnings) supports community dignity. Equal distribution to all active members.</p>
              </Card>
            </div>
          </section>
