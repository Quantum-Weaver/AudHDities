...
// GENERATED: 2026-04-13T21:47:21.199Z
// =====================================================
...
import { AnalyticsInsertSchema } from 'src/lib/validators/analytics';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('analytics' as any).select('*', { count: 'exact' });
