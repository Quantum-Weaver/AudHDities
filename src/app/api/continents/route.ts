// =====================================================
// FILE: app/api/continents/route.ts
// GENERATED: 2026-04-10T22:05:14.417Z
// =====================================================
...
import { ContinentsInsertSchema } from 'src/lib/validators/continents';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('continents' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ContinentsInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('continents' as any)
    ...
    return errorResponse('Failed to create continents', 500);
  }
}
