// =====================================================
// FILE: app/api/user_badges/route.ts
// GENERATED: 2026-04-10T22:05:14.621Z
// =====================================================
...
import { UserBadgesInsertSchema } from 'src/lib/validators/user_badges';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('user_badges' as any).select('*', { count: 'exact' });
