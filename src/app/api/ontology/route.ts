// =====================================================
// FILE: app/api/ontology/route.ts
// GENERATED: 2026-04-10T22:05:14.451Z
// =====================================================
...
import { OntologyInsertSchema } from 'src/lib/validators/ontology';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('ontology' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = OntologyInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('ontology' as any)
    ...
    return errorResponse('Failed to create ontology', 500);
  }
}
