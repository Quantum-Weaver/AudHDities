...
// GENERATED: 2026-04-13T21:47:21.244Z
// =====================================================
...
import { ProcessesInsertSchema } from 'src/lib/validators/processes';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('processes' as any).select('*', { count: 'exact' });
