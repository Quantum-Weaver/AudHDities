...
// GENERATED: 2026-04-13T21:47:21.205Z
// =====================================================
...
import { ChannelsInsertSchema } from 'src/lib/validators/channels';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('channels' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ChannelsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create channels', 500);
  }
}
