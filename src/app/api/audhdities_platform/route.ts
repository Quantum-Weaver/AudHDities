// =====================================================
// FILE: app/api/audhdities_platform/route.ts
// GENERATED: 2026-04-13T21:47:21.201Z
// =====================================================
...
import { AudhditiesPlatformInsertSchema } from 'src/lib/validators/audhdities_platform';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('audhdities_platform' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('audhdities_platform' as any)
    ...
    return errorResponse('Failed to create audhdities_platform', 500);
  }
}
