...
import { UserBubblePopsInsertSchema } from '@/lib/validators/generated/athena-gamification/user_bubble_pops';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = UserBubblePopsInsertSchema.parse(body);
    ...
    console.error('Error creating user_bubble_pops:', error);
    return errorResponse('Failed to create user_bubble_pops', 500);
  }
}
