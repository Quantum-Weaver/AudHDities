...
import { BubbleSuperpositionInsertSchema } from '@/lib/validators/generated/athena-gamification/bubble_superposition';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:30:03.581Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = BubbleSuperpositionInsertSchema.parse(body);
    ...
    console.error('Error creating bubble_superposition:', error);
    return errorResponse('Failed to create bubble_superposition', 500);
  }
}
