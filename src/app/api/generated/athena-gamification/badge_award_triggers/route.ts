...
import { BadgeAwardTriggersInsertSchema } from '@/lib/validators/generated/athena-gamification/badge_award_triggers';
import { NextRequest } from 'next/server';

// Generated: 2026-05-01T03:24:41.135Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = BadgeAwardTriggersInsertSchema.parse(body);
    ...
    console.error('Error creating badge_award_triggers:', error);
    return errorResponse('Failed to create badge_award_triggers', 500);
  }
}
