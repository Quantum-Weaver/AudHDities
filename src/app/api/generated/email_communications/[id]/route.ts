// =====================================================
// API ROUTE: /api/email_communications/[id]
  ...
  try {
    ...
    if (error) {
      if (error.code === 'PGRST116') {
        return notFound('email_communications');
      }
      throw error;
    }
...
import { EmailCommunicationsUpdateSchema } from 'src/lib/validators/email_communications';
