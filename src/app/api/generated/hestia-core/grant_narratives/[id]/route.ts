...
import { GrantNarrativesUpdateSchema } from '@/lib/validators/generated/hestia-core/grant_narratives';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('grant_narratives').delete().eq('grant_narratives_id', id);
