...
import { SensoryLexiconUpdateSchema } from '@/lib/validators/generated/hestia-core/sensory_lexicon';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('sensory_lexicon').delete().eq('sensory_lexicon_id', id);
