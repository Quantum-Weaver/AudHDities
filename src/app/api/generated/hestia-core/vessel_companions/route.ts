...
import { VesselCompanionsInsertSchema } from '@/lib/validators/generated/hestia-core/vessel_companions';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:17:11.236Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselCompanionsInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_companions:', error);
    return errorResponse('Failed to create vessel_companions', 500);
  }
}
