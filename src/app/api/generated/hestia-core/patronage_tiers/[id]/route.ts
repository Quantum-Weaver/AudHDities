...
import { PatronageTiersUpdateSchema } from '@/lib/validators/generated/hestia-core/patronage_tiers';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('patronage_tiers').delete().eq('patronage_tiers_id', id);
