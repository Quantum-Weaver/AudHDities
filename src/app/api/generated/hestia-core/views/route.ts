...
import { ViewsInsertSchema } from '@/lib/validators/generated/hestia-core/views';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T16:03:07.175Z
// Table: views
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ViewsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create views', 500);
  }
}
