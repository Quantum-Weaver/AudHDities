...
import { CollectionSetsInsertSchema } from '@/lib/validators/generated/hestia-core/collection_sets';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = CollectionSetsInsertSchema.parse(body);
    ...
    console.error('Error creating collection_sets:', error);
    return errorResponse('Failed to create collection_sets', 500);
  }
}
