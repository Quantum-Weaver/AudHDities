...
// Generated: 2026-07-31T00:35:01.620Z
// Table: plant_stages
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PlantStagesInsertSchema.parse(body);
    ...
    console.error('Error creating plant_stages:', error);
    return errorResponse('Failed to create plant_stages', 500);
  }
}
