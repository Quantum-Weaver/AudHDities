...
import { PlatformSettingsUpdateSchema } from '@/lib/validators/generated/hestia-core/platform_settings';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.648Z
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('platform_settings').delete().eq('platform_settings_id', id);
