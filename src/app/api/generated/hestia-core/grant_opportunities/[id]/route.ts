...
import { GrantOpportunitiesUpdateSchema } from '@/lib/validators/generated/hestia-core/grant_opportunities';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('grant_opportunities').delete().eq('grant_opportunities_id', id);
