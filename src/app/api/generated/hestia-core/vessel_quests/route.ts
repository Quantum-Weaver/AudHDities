...
// Generated: 2026-08-01T21:41:40.631Z
// Table: vessel_quests
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselQuestsInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_quests:', error);
    return errorResponse('Failed to create vessel_quests', 500);
  }
}
