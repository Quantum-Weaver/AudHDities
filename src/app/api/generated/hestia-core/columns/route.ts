...
import { ColumnsInsertSchema } from '@/lib/validators/generated/hestia-core/columns';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T00:35:01.273Z
// Table: columns
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ColumnsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create columns', 500);
  }
}
