...
import { VesselInteriorsInsertSchema } from '@/lib/validators/generated/hestia-core/vessel_interiors';
import { NextRequest } from 'next/server';

// Generated: 2026-07-29T16:16:54.121Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselInteriorsInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_interiors:', error);
    return errorResponse('Failed to create vessel_interiors', 500);
  }
}
