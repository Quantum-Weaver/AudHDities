...
// Generated: 2026-04-30T00:26:46.842Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = UserBubbleLimitsInsertSchema.parse(body);
    ...
    console.error('Error creating user_bubble_limits:', error);
    return errorResponse('Failed to create user_bubble_limits', 500);
  }
}
