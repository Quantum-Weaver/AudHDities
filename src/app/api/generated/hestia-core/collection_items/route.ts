...
// Generated: 2026-07-28T15:33:49.612Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = CollectionItemsInsertSchema.parse(body);
    ...
    console.error('Error creating collection_items:', error);
    return errorResponse('Failed to create collection_items', 500);
  }
}
