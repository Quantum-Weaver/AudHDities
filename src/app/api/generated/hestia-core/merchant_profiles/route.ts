...
import { MerchantProfilesInsertSchema } from '@/lib/validators/generated/hestia-core/merchant_profiles';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.573Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = MerchantProfilesInsertSchema.parse(body);
    ...
    console.error('Error creating merchant_profiles:', error);
    return errorResponse('Failed to create merchant_profiles', 500);
  }
}
