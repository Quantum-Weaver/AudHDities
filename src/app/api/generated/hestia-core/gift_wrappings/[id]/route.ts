...
import { GiftWrappingsUpdateSchema } from '@/lib/validators/generated/hestia-core/gift_wrappings';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('gift_wrappings').delete().eq('gift_wrappings_id', id);
