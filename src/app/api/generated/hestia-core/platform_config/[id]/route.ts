...
import { PlatformConfigUpdateSchema } from '@/lib/validators/generated/hestia-core/platform_config';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('platform_config').delete().eq('platform_config_id', id);
