...
import { GenerationsUpdateSchema } from '@/lib/validators/generated/hestia-core/generations';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.458Z
// Table: generations
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('generations').delete().eq('generations_id', id);
