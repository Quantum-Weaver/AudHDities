...
import { GrantAttachmentsUpdateSchema } from '@/lib/validators/generated/hestia-core/grant_attachments';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('grant_attachments').delete().eq('grant_attachments_id', id);
