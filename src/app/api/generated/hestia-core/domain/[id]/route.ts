...
import { DomainUpdateSchema } from '@/lib/validators/generated/hestia-core/domain';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.378Z
// Table: domain
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('domain').delete().eq('domain_id', id);
