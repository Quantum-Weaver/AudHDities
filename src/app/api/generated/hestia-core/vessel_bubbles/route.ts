...
// Generated: 2026-07-18T21:42:54.611Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselBubblesInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_bubbles:', error);
    return errorResponse('Failed to create vessel_bubbles', 500);
  }
}
