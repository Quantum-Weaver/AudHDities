...
import { EnergyLogsInsertSchema } from '@/lib/validators/generated/hestia-core/energy_logs';
import { NextRequest } from 'next/server';

// Generated: 2026-04-30T15:32:13.440Z
// Table: energy_logs
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = EnergyLogsInsertSchema.parse(body);
    ...
    console.error('Error creating energy_logs:', error);
    return errorResponse('Failed to create energy_logs', 500);
  }
}
