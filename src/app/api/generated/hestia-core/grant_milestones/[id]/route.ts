...
import { GrantMilestonesUpdateSchema } from '@/lib/validators/generated/hestia-core/grant_milestones';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('grant_milestones').delete().eq('grant_milestones_id', id);
