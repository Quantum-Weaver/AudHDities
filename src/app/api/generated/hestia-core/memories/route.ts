...
import { MemoriesInsertSchema } from '@/lib/validators/generated/hestia-core/memories';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = MemoriesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create memories', 500);
  }
}
