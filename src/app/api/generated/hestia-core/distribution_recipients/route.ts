...
import { DistributionRecipientsInsertSchema } from '@/lib/validators/generated/hestia-core/distribution_recipients';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = DistributionRecipientsInsertSchema.parse(body);
    ...
    console.error('Error creating distribution_recipients:', error);
    return errorResponse('Failed to create distribution_recipients', 500);
  }
}
