...
import { VesselConfigInsertSchema } from '@/lib/validators/generated/hestia-core/vessel_config';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:17:11.241Z
// Table: vessel_config
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselConfigInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_config:', error);
    return errorResponse('Failed to create vessel_config', 500);
  }
}
