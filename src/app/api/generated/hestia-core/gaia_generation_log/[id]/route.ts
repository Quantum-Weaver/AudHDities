...
import { GaiaGenerationLogUpdateSchema } from '@/lib/validators/generated/hestia-core/gaia_generation_log';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('gaia_generation_log').delete().eq('gaia_generation_log_id', id);
