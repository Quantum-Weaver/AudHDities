...
import { SigilUnlocksInsertSchema } from '@/lib/validators/generated/hestia-core/sigil_unlocks';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = SigilUnlocksInsertSchema.parse(body);
    ...
    console.error('Error creating sigil_unlocks:', error);
    return errorResponse('Failed to create sigil_unlocks', 500);
  }
}
