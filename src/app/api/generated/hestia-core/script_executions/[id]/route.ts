...
import { ScriptExecutionsUpdateSchema } from '@/lib/validators/generated/hestia-core/script_executions';
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('script_executions').delete().eq('script_executions_id', id);
