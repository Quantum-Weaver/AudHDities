...
import { HeraldsInsertSchema } from '@/lib/validators/generated/hestia-core/heralds';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T00:35:01.506Z
// Table: heralds
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = HeraldsInsertSchema.parse(body);
    ...
    console.error('Error creating heralds:', error);
    return errorResponse('Failed to create heralds', 500);
  }
}
