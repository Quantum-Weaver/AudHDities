...
import { VesselDecorationsInsertSchema } from '@/lib/validators/generated/hestia-core/vessel_decorations';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:30:04.174Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VesselDecorationsInsertSchema.parse(body);
    ...
    console.error('Error creating vessel_decorations:', error);
    return errorResponse('Failed to create vessel_decorations', 500);
  }
}
