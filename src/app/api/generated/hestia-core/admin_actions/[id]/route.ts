...
import { AdminActionsUpdateSchema } from '@/lib/validators/generated/hestia-core/admin_actions';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.183Z
// Table: admin_actions
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('admin_actions').delete().eq('admin_actions_id', id);
