...
import { GrantApplicationsUpdateSchema } from '@/lib/validators/generated/hestia-core/grant_applications';
import { NextRequest } from 'next/server';

// Generated: 2026-07-10T18:14:59.482Z
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('grant_applications').delete().eq('grant_applications_id', id);
