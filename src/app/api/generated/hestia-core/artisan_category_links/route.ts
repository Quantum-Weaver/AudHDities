...
import { ArtisanCategoryLinksInsertSchema } from '@/lib/validators/generated/hestia-core/artisan_category_links';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ArtisanCategoryLinksInsertSchema.parse(body);
    ...
    console.error('Error creating artisan_category_links:', error);
    return errorResponse('Failed to create artisan_category_links', 500);
  }
}
