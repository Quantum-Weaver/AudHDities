...
import { AdminActionsInsertSchema } from '@/lib/validators/generated/themis-governance/admin_actions';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T00:35:01.127Z
// Table: admin_actions
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AdminActionsInsertSchema.parse(body);
    ...
    console.error('Error creating admin_actions:', error);
    return errorResponse('Failed to create admin_actions', 500);
  }
}
