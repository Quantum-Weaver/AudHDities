...
import { VotesInsertSchema } from '@/lib/validators/generated/themis-governance/votes';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T16:03:07.183Z
// Table: votes
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = VotesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create votes', 500);
  }
}
