...
import type { ProcessesInsertSchema } from '@/lib/validators/generated/themis-governance/processes.ts';
import { NextRequest } from 'next/server';

// =====================================================
// API ROUTE: /api/generated/themis-governance/processes
// METHODS: GET, POST
// GENERATED: 2026-04-15T16:41:40.341Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ProcessesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create processes', 500);
  }
}
