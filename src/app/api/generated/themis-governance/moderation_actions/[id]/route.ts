...
import type { ModerationActionsRowSchema, ModerationActionsUpdateSchema } from '@/lib/validators/generated/themis-governance/moderation_actions.ts';
  ...
  try {
    ...
    if (error) {
      if (error.code === 'PGRST116') {
        return notFound('moderation_actions');
      }
      throw error;
    }
