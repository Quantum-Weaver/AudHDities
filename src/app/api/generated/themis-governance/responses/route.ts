...
import { ResponsesInsertSchema } from '@/lib/validators/generated/themis-governance/responses';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T00:35:01.710Z
// Table: responses
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ResponsesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create responses', 500);
  }
}
