// =====================================================
// API ROUTE: /api/prometheus_generations/[id]
  ...
  try {
    ...
    if (error) {
      if (error.code === 'PGRST116') {
        return notFound('prometheus_generations');
      }
      throw error;
    }
...
import { PrometheusGenerationsUpdateSchema } from 'src/lib/validators/prometheus_generations';
