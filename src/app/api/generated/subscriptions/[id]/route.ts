// =====================================================
// API ROUTE: /api/subscriptions/[id]
// METHODS: GET, PUT, DELETE
// GENERATED: 2026-04-12T23:25:46.113Z
...
import { SubscriptionsUpdateSchema } from 'src/lib/validators/subscriptions';
...
export async function PUT(
  ...
  try {
    ...
    const validated = SubscriptionsUpdateSchema.parse(body);
    ...
    return errorResponse('Failed to update subscriptions', 500);
  }
}
import { NextRequest } from 'next/server';
import { createApiSupabase } from 'src/lib/api/supabase';
