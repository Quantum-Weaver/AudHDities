// =====================================================
// API ROUTE: /api/user_quests
// METHODS: GET, POST
// GENERATED: 2026-04-12T23:25:46.119Z
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('user_quests').select('*', { count: 'exact' });
...
import { UserQuestsInsertSchema } from 'src/lib/validators/generated/user_quests';
