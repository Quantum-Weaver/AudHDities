...
import { GenerationTemplatesInsertSchema } from '@/lib/validators/generated/daedalus-meta/generation_templates';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:17:10.822Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GenerationTemplatesInsertSchema.parse(body);
    ...
    console.error('Error creating generation_templates:', error);
    return errorResponse('Failed to create generation_templates', 500);
  }
}
