...
import { FunctionsInsertSchema } from '@/lib/validators/generated/daedalus-meta/functions';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T16:03:06.532Z
// Table: functions
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = FunctionsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create functions', 500);
  }
}
