...
import { TemplatesInsertSchema } from '@/lib/validators/generated/daedalus-meta/templates';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:09:31.570Z
// Table: templates
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = TemplatesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create templates', 500);
  }
}
