...
import type { SupabaseConnectionRowSchema, SupabaseConnectionUpdateSchema } from '@/lib/validators/generated/aethelred-connections/supabase_connection.ts';
import { NextRequest } from 'next/server';

// =====================================================
// API ROUTE: /api/generated/aethelred-connections/supabase_connection/[id]
  ...
  try {
    ...
    if (error) {
      if (error.code === 'PGRST116') {
        return notFound('supabase_connection');
      }
      throw error;
    }
