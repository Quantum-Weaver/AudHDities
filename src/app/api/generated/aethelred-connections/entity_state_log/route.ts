...
import { EntityStateLogInsertSchema } from '@/lib/validators/generated/aethelred-connections/entity_state_log';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = EntityStateLogInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create entity_state_log', 500);
  }
}
