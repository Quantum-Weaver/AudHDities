...
import { AgentMessagesInsertSchema } from '@/lib/validators/generated/aethelred-connections/agent_messages';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:09:30.994Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AgentMessagesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create agent_messages', 500);
  }
}
