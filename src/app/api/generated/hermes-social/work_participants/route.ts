...
import { WorkParticipantsInsertSchema } from '@/lib/validators/generated/hermes-social/work_participants';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T01:03:41.896Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = WorkParticipantsInsertSchema.parse(body);
    ...
    console.error('Error creating work_participants:', error);
    return errorResponse('Failed to create work_participants', 500);
  }
}
