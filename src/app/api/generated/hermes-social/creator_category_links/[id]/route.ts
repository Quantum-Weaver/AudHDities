...
import { CreatorCategoryLinksUpdateSchema } from '@/lib/validators/generated/hermes-social/creator_category_links';
import { NextRequest } from 'next/server';

// Generated: 2026-05-01T03:24:41.303Z
...
export async function DELETE(
  ...
  try {
    ...
    const supabase = await createApiSupabase();
    const { error } = await supabase.from('creator_category_links').delete().eq('creator_category_links_id', id);
