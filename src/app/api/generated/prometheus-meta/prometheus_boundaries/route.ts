...
import type { PrometheusBoundariesInsertSchema } from '@/lib/validators/generated/prometheus-meta/prometheus_boundaries.ts';
import { NextRequest } from 'next/server';

// =====================================================
// API ROUTE: /api/generated/prometheus-meta/prometheus_boundaries
// METHODS: GET, POST
// GENERATED: 2026-04-15T16:41:40.348Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PrometheusBoundariesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create prometheus_boundaries', 500);
  }
}
