...
import { AssessmentAnswersInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/assessment_answers';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T21:41:40.431Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AssessmentAnswersInsertSchema.parse(body);
    ...
    console.error('Error creating assessment_answers:', error);
    return errorResponse('Failed to create assessment_answers', 500);
  }
}
