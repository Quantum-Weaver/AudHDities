...
import { AnchorEventsInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/anchor_events';
import { NextRequest } from 'next/server';

// Generated: 2026-07-20T04:39:10.332Z
// Table: anchor_events
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AnchorEventsInsertSchema.parse(body);
    ...
    console.error('Error creating anchor_events:', error);
    return errorResponse('Failed to create anchor_events', 500);
  }
}
