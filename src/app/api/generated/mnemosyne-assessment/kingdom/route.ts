...
import { KingdomInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/kingdom';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = KingdomInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create kingdom', 500);
  }
}
