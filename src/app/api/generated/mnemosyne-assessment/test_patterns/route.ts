...
import { TestPatternsInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/test_patterns';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T21:42:54.564Z
// Table: test_patterns
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = TestPatternsInsertSchema.parse(body);
    ...
    console.error('Error creating test_patterns:', error);
    return errorResponse('Failed to create test_patterns', 500);
  }
}
