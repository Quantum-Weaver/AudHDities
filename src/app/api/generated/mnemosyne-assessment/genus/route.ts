...
import { GenusInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/genus';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T21:42:54.190Z
// Table: genus
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GenusInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create genus', 500);
  }
}
