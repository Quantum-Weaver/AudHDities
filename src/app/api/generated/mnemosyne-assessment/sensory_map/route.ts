...
import { SensoryMapInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/sensory_map';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T21:42:54.503Z
// Table: sensory_map
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = SensoryMapInsertSchema.parse(body);
    ...
    console.error('Error creating sensory_map:', error);
    return errorResponse('Failed to create sensory_map', 500);
  }
}
