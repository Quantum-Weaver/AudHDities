...
import { MindTraitsInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/mind_traits';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:17:10.952Z
// Table: mind_traits
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = MindTraitsInsertSchema.parse(body);
    ...
    console.error('Error creating mind_traits:', error);
    return errorResponse('Failed to create mind_traits', 500);
  }
}
