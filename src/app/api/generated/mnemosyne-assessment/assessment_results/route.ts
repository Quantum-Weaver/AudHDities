...
import { AssessmentResultsInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/assessment_results';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T16:03:06.270Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = AssessmentResultsInsertSchema.parse(body);
    ...
    console.error('Error creating assessment_results:', error);
    return errorResponse('Failed to create assessment_results', 500);
  }
}
