...
import { KeywordsInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/keywords';
import { NextRequest } from 'next/server';

// Generated: 2026-07-28T05:07:04.289Z
// Table: keywords
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = KeywordsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create keywords', 500);
  }
}
