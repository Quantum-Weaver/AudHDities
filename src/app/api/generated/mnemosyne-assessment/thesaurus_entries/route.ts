...
import { ThesaurusEntriesInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/thesaurus_entries';
import { NextRequest } from 'next/server';

// Generated: 2026-07-20T04:39:10.918Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ThesaurusEntriesInsertSchema.parse(body);
    ...
    console.error('Error creating thesaurus_entries:', error);
    return errorResponse('Failed to create thesaurus_entries', 500);
  }
}
