...
import { PhylumInsertSchema } from '@/lib/validators/generated/mnemosyne-assessment/phylum';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:17:10.998Z
// Table: phylum
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PhylumInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create phylum', 500);
  }
}
