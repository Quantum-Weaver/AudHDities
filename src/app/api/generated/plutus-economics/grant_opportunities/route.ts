...
import { GrantOpportunitiesInsertSchema } from '@/lib/validators/generated/plutus-economics/grant_opportunities';
import { NextRequest } from 'next/server';

// Generated: 2026-07-20T04:39:10.610Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GrantOpportunitiesInsertSchema.parse(body);
    ...
    console.error('Error creating grant_opportunities:', error);
    return errorResponse('Failed to create grant_opportunities', 500);
  }
}
