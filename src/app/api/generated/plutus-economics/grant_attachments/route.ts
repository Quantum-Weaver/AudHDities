...
import { GrantAttachmentsInsertSchema } from '@/lib/validators/generated/plutus-economics/grant_attachments';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:09:31.253Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GrantAttachmentsInsertSchema.parse(body);
    ...
    console.error('Error creating grant_attachments:', error);
    return errorResponse('Failed to create grant_attachments', 500);
  }
}
