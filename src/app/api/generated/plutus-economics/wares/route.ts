...
import { WaresInsertSchema } from '@/lib/validators/generated/plutus-economics/wares';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T23:30:04.208Z
// Table: wares
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = WaresInsertSchema.parse(body);
    ...
    console.error('Error creating wares:', error);
    return errorResponse('Failed to create wares', 500);
  }
}
