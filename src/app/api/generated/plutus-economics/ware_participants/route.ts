...
import { WareParticipantsInsertSchema } from '@/lib/validators/generated/plutus-economics/ware_participants';
import { NextRequest } from 'next/server';

// Generated: 2026-08-01T21:41:40.640Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = WareParticipantsInsertSchema.parse(body);
    ...
    console.error('Error creating ware_participants:', error);
    return errorResponse('Failed to create ware_participants', 500);
  }
}
