...
import { ExchangesInsertSchema } from '@/lib/validators/generated/plutus-economics/exchanges';
import { NextRequest } from 'next/server';

// Generated: 2026-07-18T21:42:54.129Z
// Table: exchanges
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ExchangesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create exchanges', 500);
  }
}
