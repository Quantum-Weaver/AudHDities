...
import { GrantNarrativesInsertSchema } from '@/lib/validators/generated/plutus-economics/grant_narratives';
import { NextRequest } from 'next/server';

// Generated: 2026-07-29T16:16:53.814Z
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GrantNarrativesInsertSchema.parse(body);
    ...
    console.error('Error creating grant_narratives:', error);
    return errorResponse('Failed to create grant_narratives', 500);
  }
}
