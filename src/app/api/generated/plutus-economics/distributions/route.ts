...
import { DistributionsInsertSchema } from '@/lib/validators/generated/plutus-economics/distributions';
import { NextRequest } from 'next/server';

// Generated: 2026-07-31T23:16:54.412Z
// Table: distributions
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = DistributionsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create distributions', 500);
  }
}
