...
import { PatronageInsertSchema } from '@/lib/validators/generated/plutus-economics/patronage';
import { NextRequest } from 'next/server';

// Generated: 2026-07-28T05:07:04.375Z
// Table: patronage
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PatronageInsertSchema.parse(body);
    ...
    console.error('Error creating patronage:', error);
    return errorResponse('Failed to create patronage', 500);
  }
}
