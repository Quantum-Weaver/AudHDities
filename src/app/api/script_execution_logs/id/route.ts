// =====================================================
// FILE: app/api/script_execution_logs/route.ts
// GENERATED: 2026-04-13T21:47:21.273Z
// =====================================================
...
import { ScriptExecutionLogsInsertSchema } from 'src/lib/validators/script_execution_logs';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('script_execution_logs' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ScriptExecutionLogsInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('script_execution_logs' as any)
    ...
    return errorResponse('Failed to create script_execution_logs', 500);
  }
}
