// =====================================================
// FILE: app/api/github_connection/route.ts
// GENERATED: 2026-04-13T21:47:21.229Z
// =====================================================
...
import { GithubConnectionInsertSchema } from 'src/lib/validators/github_connection';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('github_connection' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = GithubConnectionInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('github_connection' as any)
    ...
    return errorResponse('Failed to create github_connection', 500);
  }
}
