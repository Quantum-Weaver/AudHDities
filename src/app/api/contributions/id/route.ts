...
// GENERATED: 2026-04-13T21:47:21.212Z
// =====================================================
...
import { ContributionsInsertSchema } from 'src/lib/validators/contributions';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('contributions' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ContributionsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create contributions', 500);
  }
}
