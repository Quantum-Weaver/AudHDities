// =====================================================
// FILE: app/api/codex/route.ts
// GENERATED: 2026-04-13T21:47:21.206Z
// =====================================================
...
import { CodexInsertSchema } from 'src/lib/validators/codex';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('codex' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = CodexInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create codex', 500);
  }
}
