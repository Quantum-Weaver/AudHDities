// =====================================================
// FILE: app/api/creator_category_links/route.ts
...
import { CreatorCategoryLinksInsertSchema } from 'src/lib/validators/creator_category_links';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('creator_category_links' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('creator_category_links' as any)
