// =====================================================
// FILE: app/api/user_quests/route.ts
// GENERATED: 2026-04-10T22:05:14.634Z
// =====================================================
...
import { UserQuestsInsertSchema } from 'src/lib/validators/user_quests';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('user_quests' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating user_quests:', error);
    return errorResponse('Failed to create user_quests', 500);
  }
}
