// =====================================================
// FILE: app/api/moderation_actions/route.ts
// GENERATED: 2026-04-13T21:47:21.237Z
// =====================================================
...
import { ModerationActionsInsertSchema } from 'src/lib/validators/moderation_actions';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('moderation_actions' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ModerationActionsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create moderation_actions', 500);
  }
}
