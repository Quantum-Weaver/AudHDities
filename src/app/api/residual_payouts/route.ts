// =====================================================
// FILE: app/api/residual_payouts/route.ts
// GENERATED: 2026-04-13T21:47:21.265Z
// =====================================================
...
import { ResidualPayoutsInsertSchema } from 'src/lib/validators/residual_payouts';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('residual_payouts' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create residual_payouts', 500);
  }
}
