// =====================================================
// FILE: app/api/emeralds/route.ts
// GENERATED: 2026-04-10T22:05:14.432Z
// =====================================================
...
import { EmeraldsInsertSchema } from 'src/lib/validators/emeralds';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('emeralds' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = EmeraldsInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('emeralds' as any)
    ...
    return errorResponse('Failed to create emeralds', 500);
  }
}
