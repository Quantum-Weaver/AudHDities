// =====================================================
// FILE: app/api/folksonomy/route.ts
...
import { FolksonomyInsertSchema } from 'src/lib/validators/folksonomy';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('folksonomy' as any).select('*', { count: 'exact' });
