// =====================================================
// FILE: app/api/culturalization/route.ts
// GENERATED: 2026-04-13T21:47:21.219Z
// =====================================================
...
import { CulturalizationInsertSchema } from 'src/lib/validators/culturalization';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('culturalization' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = CulturalizationInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('culturalization' as any)
    ...
    return errorResponse('Failed to create culturalization', 500);
  }
}
