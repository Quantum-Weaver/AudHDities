// =====================================================
// FILE: app/api/email_communications/route.ts
// GENERATED: 2026-04-13T21:47:21.222Z
// =====================================================
...
import { EmailCommunicationsInsertSchema } from 'src/lib/validators/email_communications';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('email_communications' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('email_communications' as any)
