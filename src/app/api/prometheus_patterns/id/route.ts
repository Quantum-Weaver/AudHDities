// =====================================================
// FILE: app/api/prometheus_patterns/route.ts
// GENERATED: 2026-04-13T21:47:21.253Z
// =====================================================
...
import { PrometheusPatternsInsertSchema } from 'src/lib/validators/prometheus_patterns';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_patterns' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PrometheusPatternsInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('prometheus_patterns' as any)
    ...
    return errorResponse('Failed to create prometheus_patterns', 500);
  }
}
