// =====================================================
// FILE: app/api/creator_profiles/route.ts
// GENERATED: 2026-04-13T21:47:21.218Z
// =====================================================
...
import { CreatorProfilesInsertSchema } from 'src/lib/validators/creator_profiles';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('creator_profiles' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating creator_profiles:', error);
    return errorResponse('Failed to create creator_profiles', 500);
  }
}
