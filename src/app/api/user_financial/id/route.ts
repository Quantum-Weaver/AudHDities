// =====================================================
// FILE: app/api/user_financial/route.ts
// GENERATED: 2026-04-10T22:05:14.630Z
// =====================================================
...
import { UserFinancialInsertSchema } from 'src/lib/validators/user_financial';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('user_financial' as any).select('*', { count: 'exact' });
