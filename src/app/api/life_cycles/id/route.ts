// =====================================================
// FILE: app/api/life_cycles/route.ts
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('life_cycles' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create life_cycles', 500);
  }
}
