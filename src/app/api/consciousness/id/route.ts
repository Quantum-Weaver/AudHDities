...
// GENERATED: 2026-04-13T21:47:21.209Z
// =====================================================
...
import { ConsciousnessInsertSchema } from 'src/lib/validators/consciousness';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('consciousness' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ConsciousnessInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('consciousness' as any)
    ...
    return errorResponse('Failed to create consciousness', 500);
  }
}
