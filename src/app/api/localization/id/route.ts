// =====================================================
// FILE: app/api/localization/route.ts
// GENERATED: 2026-04-10T22:05:14.446Z
// =====================================================
...
import { LocalizationInsertSchema } from 'src/lib/validators/localization';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('localization' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create localization', 500);
  }
}
