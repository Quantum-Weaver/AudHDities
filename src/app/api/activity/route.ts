...
// GENERATED: 2026-04-10T22:05:14.396Z
// =====================================================
...
import { ActivityInsertSchema } from 'src/lib/validators/activity';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('activity' as any).select('*', { count: 'exact' });
