// =====================================================
// FILE: app/api/seer/route.ts
// GENERATED: 2026-04-10T22:05:14.570Z
// =====================================================
...
import { SeerInsertSchema } from 'src/lib/validators/seer';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('seer' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create seer', 500);
  }
}
