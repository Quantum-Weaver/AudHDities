// =====================================================
// FILE: app/api/prometheus_memories/route.ts
// GENERATED: 2026-04-13T21:47:21.252Z
// =====================================================
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_memories' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('prometheus_memories' as any)
    ...
    return errorResponse('Failed to create prometheus_memories', 500);
  }
}
