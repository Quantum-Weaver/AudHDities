...
// GENERATED: 2026-04-10T22:05:14.610Z
// =====================================================
...
import { TimelinesInsertSchema } from 'src/lib/validators/timelines';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('timelines' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create timelines', 500);
  }
}
