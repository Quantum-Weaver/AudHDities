// =====================================================
// FILE: app/api/council_houses/route.ts
// GENERATED: 2026-04-13T21:47:21.214Z
// =====================================================
...
import { CouncilHousesInsertSchema } from 'src/lib/validators/council_houses';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('council_houses' as any).select('*', { count: 'exact' });
