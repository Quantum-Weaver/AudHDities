// =====================================================
// FILE: app/api/scene_participants/route.ts
// GENERATED: 2026-04-13T21:47:21.269Z
// =====================================================
...
import { SceneParticipantsInsertSchema } from 'src/lib/validators/scene_participants';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('scene_participants' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('scene_participants' as any)
