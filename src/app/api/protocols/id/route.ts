// =====================================================
// FILE: app/api/protocols/route.ts
// GENERATED: 2026-04-10T22:05:14.465Z
// =====================================================
...
import { ProtocolsInsertSchema } from 'src/lib/validators/protocols';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('protocols' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create protocols', 500);
  }
}
