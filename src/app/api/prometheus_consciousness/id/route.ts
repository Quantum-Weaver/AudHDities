// =====================================================
// FILE: app/api/prometheus_consciousness/route.ts
// GENERATED: 2026-04-13T21:47:21.250Z
// =====================================================
...
import { PrometheusConsciousnessInsertSchema } from 'src/lib/validators/prometheus_consciousness';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_consciousness' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PrometheusConsciousnessInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('prometheus_consciousness' as any)
    ...
    return errorResponse('Failed to create prometheus_consciousness', 500);
  }
}
