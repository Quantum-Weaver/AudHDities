// =====================================================
// FILE: app/api/file_registry/route.ts
// GENERATED: 2026-04-13T21:47:21.226Z
// =====================================================
...
import { FileRegistryInsertSchema } from 'src/lib/validators/file_registry';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('file_registry' as any).select('*', { count: 'exact' });
