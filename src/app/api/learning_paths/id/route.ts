// =====================================================
// FILE: app/api/learning_paths/route.ts
// GENERATED: 2026-04-10T22:05:14.442Z
// =====================================================
...
import { LearningPathsInsertSchema } from 'src/lib/validators/learning_paths';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('learning_paths' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create learning_paths', 500);
  }
}
