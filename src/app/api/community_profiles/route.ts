// =====================================================
// FILE: app/api/community_profiles/route.ts
// GENERATED: 2026-04-10T22:05:14.412Z
// =====================================================
...
import { CommunityProfilesInsertSchema } from 'src/lib/validators/community_profiles';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('community_profiles' as any).select('*', { count: 'exact' });
