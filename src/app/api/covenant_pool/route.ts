// =====================================================
// FILE: app/api/covenant_pool/route.ts
...
import { CovenantPoolInsertSchema } from 'src/lib/validators/covenant_pool';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('covenant_pool' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create covenant_pool', 500);
  }
}
