// =====================================================
// FILE: app/api/prometheus_blueprints/route.ts
// GENERATED: 2026-04-13T21:47:21.248Z
// =====================================================
...
import { PrometheusBlueprintsInsertSchema } from 'src/lib/validators/prometheus_blueprints';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_blueprints' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('prometheus_blueprints' as any)
