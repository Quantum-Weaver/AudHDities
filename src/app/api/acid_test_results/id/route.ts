...
// GENERATED: 2026-04-13T21:47:21.194Z
// =====================================================
...
import { AcidTestResultsInsertSchema } from 'src/lib/validators/acid_test_results';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('acid_test_results' as any).select('*', { count: 'exact' });
