...
// GENERATED: 2026-04-10T22:05:14.454Z
// =====================================================
...
import { PersonasInsertSchema } from 'src/lib/validators/personas';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('personas' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create personas', 500);
  }
}
