...
// GENERATED: 2026-04-13T21:47:21.289Z
// =====================================================
...
import { TransactionsInsertSchema } from 'src/lib/validators/transactions';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('transactions' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = TransactionsInsertSchema.parse(body);
