// =====================================================
// FILE: app/api/chancellor/route.ts
// GENERATED: 2026-04-10T22:05:14.408Z
// =====================================================
...
import { ChancellorInsertSchema } from 'src/lib/validators/chancellor';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('chancellor' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ChancellorInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('chancellor' as any)
    ...
    return errorResponse('Failed to create chancellor', 500);
  }
}
