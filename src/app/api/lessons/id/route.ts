...
// GENERATED: 2026-04-13T21:47:21.233Z
// =====================================================
...
import { LessonsInsertSchema } from 'src/lib/validators/lessons';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('lessons' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = LessonsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create lessons', 500);
  }
}
