// =====================================================
// FILE: app/api/customs/route.ts
// GENERATED: 2026-04-10T22:05:14.429Z
// =====================================================
...
import { CustomsInsertSchema } from 'src/lib/validators/customs';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('customs' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = CustomsInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create customs', 500);
  }
}
