// =====================================================
// FILE: app/api/executioner/route.ts
// GENERATED: 2026-04-10T22:05:14.434Z
// =====================================================
...
import { ExecutionerInsertSchema } from 'src/lib/validators/executioner';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('executioner' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = ExecutionerInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('executioner' as any)
    ...
    return errorResponse('Failed to create executioner', 500);
  }
}
