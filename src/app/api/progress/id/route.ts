...
// GENERATED: 2026-04-13T21:47:21.247Z
// =====================================================
...
import { ProgressInsertSchema } from 'src/lib/validators/progress';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('progress' as any).select('*', { count: 'exact' });
