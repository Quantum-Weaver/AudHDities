// =====================================================
// FILE: app/api/mythology/route.ts
...
import { MythologyInsertSchema } from 'src/lib/validators/mythology';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('mythology' as any).select('*', { count: 'exact' });
