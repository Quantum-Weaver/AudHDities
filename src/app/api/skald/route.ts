// =====================================================
// FILE: app/api/skald/route.ts
// GENERATED: 2026-04-10T22:05:14.572Z
// =====================================================
...
import { SkaldInsertSchema } from 'src/lib/validators/skald';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('skald' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create skald', 500);
  }
}
