// =====================================================
// FILE: app/api/system_health_logs/route.ts
...
import { SystemHealthLogsInsertSchema } from 'src/lib/validators/system_health_logs';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('system_health_logs' as any).select('*', { count: 'exact' });
