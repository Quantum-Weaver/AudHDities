// =====================================================
// FILE: app/api/vendor_profiles/route.ts
// GENERATED: 2026-04-10T22:05:14.640Z
// =====================================================
...
import { VendorProfilesInsertSchema } from 'src/lib/validators/vendor_profiles';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('vendor_profiles' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error creating vendor_profiles:', error);
    return errorResponse('Failed to create vendor_profiles', 500);
  }
}
