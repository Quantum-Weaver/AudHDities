...
// GENERATED: 2026-04-10T22:05:14.458Z
// =====================================================
...
import { ProductsInsertSchema } from 'src/lib/validators/products';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('products' as any).select('*', { count: 'exact' });
