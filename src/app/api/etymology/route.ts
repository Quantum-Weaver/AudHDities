...
// GENERATED: 2026-04-10T22:05:14.433Z
// =====================================================
...
import { EtymologyInsertSchema } from 'src/lib/validators/etymology';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('etymology' as any).select('*', { count: 'exact' });
