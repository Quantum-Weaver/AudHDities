// =====================================================
// FILE: app/api/archivist/route.ts
// GENERATED: 2026-04-10T22:05:14.404Z
// =====================================================
...
import { ArchivistInsertSchema } from 'src/lib/validators/archivist';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('archivist' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create archivist', 500);
  }
}
