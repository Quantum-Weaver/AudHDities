...
// GENERATED: 2026-04-13T21:47:21.279Z
// =====================================================
...
import { SubscriptionsInsertSchema } from 'src/lib/validators/subscriptions';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('subscriptions' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create subscriptions', 500);
  }
}
