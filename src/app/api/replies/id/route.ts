...
// GENERATED: 2026-04-10T22:05:14.472Z
// =====================================================
...
import { RepliesInsertSchema } from 'src/lib/validators/replies';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('replies' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = RepliesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create replies', 500);
  }
}
