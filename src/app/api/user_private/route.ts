// =====================================================
// FILE: app/api/user_private/route.ts
// GENERATED: 2026-04-10T22:05:14.631Z
// =====================================================
...
import { UserPrivateInsertSchema } from 'src/lib/validators/user_private';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('user_private' as any).select('*', { count: 'exact' });
