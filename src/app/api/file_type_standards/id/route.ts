// =====================================================
// FILE: app/api/file_type_standards/route.ts
// GENERATED: 2026-04-10T22:05:14.437Z
// =====================================================
...
import { FileTypeStandardsInsertSchema } from 'src/lib/validators/file_type_standards';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('file_type_standards' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('file_type_standards' as any)
