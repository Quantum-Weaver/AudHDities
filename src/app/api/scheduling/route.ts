// =====================================================
// FILE: app/api/scheduling/route.ts
// GENERATED: 2026-04-10T22:05:14.480Z
// =====================================================
...
import { SchedulingInsertSchema } from 'src/lib/validators/scheduling';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('scheduling' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create scheduling', 500);
  }
}
