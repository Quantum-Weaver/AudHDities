// =====================================================
// FILE: app/api/prometheus_templates/route.ts
// GENERATED: 2026-04-13T21:47:21.254Z
// =====================================================
...
import { PrometheusTemplatesInsertSchema } from 'src/lib/validators/prometheus_templates';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_templates' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = PrometheusTemplatesInsertSchema.parse(body);
    
    const supabase = await createApiSupabase();
    const { data, error } = await supabase
      .from('prometheus_templates' as any)
    ...
    return errorResponse('Failed to create prometheus_templates', 500);
  }
}
