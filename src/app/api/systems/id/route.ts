// =====================================================
// FILE: app/api/systems/route.ts
// GENERATED: 2026-04-10T22:05:14.581Z
// =====================================================
...
import { SystemsInsertSchema } from 'src/lib/validators/systems';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('systems' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create systems', 500);
  }
}
