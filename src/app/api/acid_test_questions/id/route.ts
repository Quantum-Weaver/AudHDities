...
// GENERATED: 2026-04-13T21:47:21.192Z
// =====================================================
...
import { AcidTestQuestionsInsertSchema } from 'src/lib/validators/acid_test_questions';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('acid_test_questions' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('acid_test_questions' as any)
