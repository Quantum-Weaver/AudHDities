...
// GENERATED: 2026-04-10T22:05:14.617Z
// =====================================================
...
import { TranslationsInsertSchema } from 'src/lib/validators/translations';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('translations' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    return errorResponse('Failed to create translations', 500);
  }
}
