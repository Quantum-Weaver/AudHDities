...
// GENERATED: 2026-04-13T21:47:21.287Z
// =====================================================
...
import { TaxonomyInsertSchema } from 'src/lib/validators/taxonomy';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('taxonomy' as any).select('*', { count: 'exact' });
