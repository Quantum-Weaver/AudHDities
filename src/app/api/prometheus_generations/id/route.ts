// =====================================================
// FILE: app/api/prometheus_generations/route.ts
// GENERATED: 2026-04-13T21:47:21.251Z
// =====================================================
...
import { PrometheusGenerationsInsertSchema } from 'src/lib/validators/prometheus_generations';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('prometheus_generations' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await supabase
      .from('prometheus_generations' as any)
    ...
    return errorResponse('Failed to create prometheus_generations', 500);
  }
}
