...
// GENERATED: 2026-04-13T21:47:21.268Z
// =====================================================
...
import { SalesInsertSchema } from 'src/lib/validators/sales';
...
export async function GET(request: NextRequest) {
  try {
    ...
    let query = supabase.from('sales' as any).select('*', { count: 'exact' });
...
export async function POST(request: NextRequest) {
  try {
    ...
    const validated = SalesInsertSchema.parse(body);
    ...
    return errorResponse('Failed to create sales', 500);
  }
}
