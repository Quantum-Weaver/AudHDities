...
import type { ResidualPoolRow, ResidualPoolInsert, ResidualPoolUpdate } from '@/types/plutus-economics/residual_pool';
import { ResidualPoolInsertSchema, ResidualPoolUpdateSchema } from '@/lib/validators/residual_pool';
