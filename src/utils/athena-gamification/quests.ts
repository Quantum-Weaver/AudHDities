...
import type { QuestsRow, QuestsInsert, QuestsUpdate } from 'src/types/athena-gamification/quests';
import { QuestsInsertSchema, QuestsUpdateSchema } from 'src/lib/validators/quests';
