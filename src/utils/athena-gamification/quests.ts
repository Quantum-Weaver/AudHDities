...
import type { QuestsRow, QuestsInsert, QuestsUpdate } from '@/types/athena-gamification/quests';
import { QuestsInsertSchema, QuestsUpdateSchema } from '@/lib/validators/quests';
