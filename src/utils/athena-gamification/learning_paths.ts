...
import type { LearningPathsRow, LearningPathsInsert, LearningPathsUpdate } from '@/types/athena-gamification/learning_paths';
import { LearningPathsInsertSchema, LearningPathsUpdateSchema } from '@/lib/validators/learning_paths';
