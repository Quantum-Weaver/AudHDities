...
import type { LessonsRow, LessonsInsert, LessonsUpdate } from '@/types/athena-gamification/lessons';
import { LessonsInsertSchema, LessonsUpdateSchema } from '@/lib/validators/lessons';
