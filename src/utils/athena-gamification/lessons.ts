...
import type { LessonsRow, LessonsInsert, LessonsUpdate } from 'src/types/athena-gamification/lessons';
import { LessonsInsertSchema, LessonsUpdateSchema } from 'src/lib/validators/lessons';
