// src/utils/components/ui/spinner.utils.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    SPINNER UTILITIES                                      ║
...
import type { SpinnerVariant } from '@/lib/constants/components/ui/spinner.variants';
import {
  SPINNER_ANIMATION_CLASSES,
  SPINNER_ELEMENT_COUNT,
  SPINNER_STAGGER_DELAYS,
} from '@/lib/constants/components/ui/spinner.constants';
import { getSpinnerVariantClass } from '@/lib/constants/components/ui/spinner.variants';
