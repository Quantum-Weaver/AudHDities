...
import type { SurveyResponsesRow, SurveyResponsesInsert, SurveyResponsesUpdate } from '@/types/iris-communications/survey_responses';
import { SurveyResponsesInsertSchema, SurveyResponsesUpdateSchema } from '@/lib/validators/survey_responses';
