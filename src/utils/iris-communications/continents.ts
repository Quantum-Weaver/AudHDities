...
import type { ContinentsRow, ContinentsInsert, ContinentsUpdate } from '@/types/iris-communications/continents';
import { ContinentsInsertSchema, ContinentsUpdateSchema } from '@/lib/validators/continents';
