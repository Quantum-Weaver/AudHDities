...
import type { ContinentsRow, ContinentsInsert, ContinentsUpdate } from 'src/types/iris-communications/continents';
import { ContinentsInsertSchema, ContinentsUpdateSchema } from 'src/lib/validators/continents';
