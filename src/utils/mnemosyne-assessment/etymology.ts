...
import type { EtymologyRow, EtymologyInsert, EtymologyUpdate } from '@/types/mnemosyne-assessment/etymology';
import { EtymologyInsertSchema, EtymologyUpdateSchema } from '@/lib/validators/etymology';
