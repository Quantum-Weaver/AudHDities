...
import type { FolksonomyRow, FolksonomyInsert, FolksonomyUpdate } from '@/types/mnemosyne-assessment/folksonomy';
import { FolksonomyInsertSchema, FolksonomyUpdateSchema } from '@/lib/validators/folksonomy';
