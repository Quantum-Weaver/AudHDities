...
import type { SystemsRow, SystemsInsert, SystemsUpdate } from 'src/types/hephaestus-infrastructure/systems';
import { SystemsInsertSchema, SystemsUpdateSchema } from 'src/lib/validators/systems';
