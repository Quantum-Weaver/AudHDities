...
import type { ProtocolsRow, ProtocolsInsert, ProtocolsUpdate } from '@/types/hephaestus-infrastructure/protocols';
import { ProtocolsInsertSchema, ProtocolsUpdateSchema } from '@/lib/validators/protocols';
