...
import type { ProtocolsRow, ProtocolsInsert, ProtocolsUpdate } from 'src/types/hephaestus-infrastructure/protocols';
import { ProtocolsInsertSchema, ProtocolsUpdateSchema } from 'src/lib/validators/protocols';
