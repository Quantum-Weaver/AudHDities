...
import type { SeerRow, SeerInsert, SeerUpdate } from 'src/types/aethelred-connections/seer';
import { SeerInsertSchema, SeerUpdateSchema } from 'src/lib/validators/seer';
