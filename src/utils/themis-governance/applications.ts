...
import type { ApplicationsRow, ApplicationsInsert, ApplicationsUpdate } from '@/types/themis-governance/applications';
import { ApplicationsInsertSchema, ApplicationsUpdateSchema } from '@/lib/validators/applications';
