...
export default function MobileMenu() {
  ...
  const navigation = [
    ...
    { href: '/vision', label: 'Vision', icon: '👁️', glow: 'water' },
    { href: '/learn', label: 'Learn', icon: '📖', glow: 'fire' },
    { href: '/contact', label: 'Contact', icon: '📧', glow: 'fire' },
    { href: '/docs', label: 'Docs', icon: '💼', glow: 'fire' },
    { href: '/dashboard', label: 'Dashboard', icon: '🎛️', glow: 'fire' }
  ]
