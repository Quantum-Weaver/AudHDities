...
export default function MobileMenu() {
  ...
  const navigation = [
    { href: '/about', label: 'About', icon: '📜', glow: 'quantum' },
    { href: '/questionaire', label: 'Test', icon: '🏛️', glow: 'water' },
    { href: '/vision', label: 'Vision', icon: '⚡', glow: 'fire' },
    { href: '/dashboard', label: 'Dashboard', icon: '🧠', glow: 'fire' }
  ]
