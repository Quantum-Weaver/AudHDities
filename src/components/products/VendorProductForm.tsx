// src/components/products/VendorProductForm.tsx
'use client';
...
export function VendorProductForm({ mode, initialData, productId, onSuccess }: VendorProductFormProps) {
  ...
  if (success) {
    return <ProductFormSuccess mode={mode} onReturn={() => router.push('/vendor/products')} />;
  }
