...
export const PlayStationIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" role="img" aria-label="PlayStation integration – gaming platform connection">
    <defs>
      <linearGradient id="playstation-gradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#6c5ce7"/>
        <stop offset="50%" stopColor="#74b9ff"/>
        <stop offset="100%" stopColor="#00cec9"/>
      </linearGradient>
      <filter id="playstation-glow" x="-50%" y="-50%" width="200%" height="200%">
    ...
    <path 
      ...
      fill="url(#playstation-gradient)" 
      stroke="#00cec9" 
      strokeWidth="0.3" 
      filter="url(#playstation-glow)"
    />
  </svg>
);