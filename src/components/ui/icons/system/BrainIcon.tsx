...
export const BrainIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg"width="100%" height="64" viewBox="0 0 64 64" role="img" aria-label="Quantum Brain icon – neurodivergent cognition with cosmic pathways" className="cosmic-icon quantum-brain">
    <defs>
      <linearGradient id="brain-gradient" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
    ...
    {/* Original brain structure with quantum styling */}
    ...
    {/* Supporting paths thinned and styled */}
    <path d="M43,10h2c0-2.757-2.243-5-5-5v2C41.654,7,43,8.346,43,10z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M37,54h-2c0,2.757,2.243,5,5,5v-2C38.346,57,37,55.654,37,54z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M54,41v2c2.757,0,5-2.243,5-5h-2C57,39.654,55.654,41,54,41z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M39,37h-2c0,3.309,2.691,6,6,6v-2C40.794,41,39,39.206,39,37z" fill="none" stroke="#6c5ce7" strokeWidth="1.2"/>
    <path d="M41,23v-2c-3.309,0-6,2.691-6,6h2C37,24.794,38.794,23,41,23z" fill="none" stroke="#6c5ce7" strokeWidth="1.2"/>
    <path d="M25,37h-2c0,3.309,2.691,6,6,6v-2C26.794,41,25,39.206,25,37z" fill="none" stroke="#6c5ce7" strokeWidth="1.2"/>
    <path d="M40,28h-2c0,3.309,2.691,6,6,6v-2C41.794,32,40,30.206,40,28z" fill="none" stroke="#6c5ce7" strokeWidth="1.2"/>
    <path d="M27,23v-2c-3.309,0-6,2.691-6,6h2C23,24.794,24.794,23,27,23z" fill="none" stroke="#6c5ce7" strokeWidth="1.2"/>
    <path d="M14,36h2c0-2.206,1.794-4,4-4v-2C16.691,30,14,32.691,14,36z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M15,50v2c2.757,0,5-2.243,5-5h-2C18,48.654,16.654,50,15,50z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M5,26h2c0-1.654,1.346-3,3-3v-2C7.243,21,5,23.243,5,26z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M15,12v2c1.654,0,3,1.346,3,3h2C20,14.243,17.757,12,15,12z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
    <path d="M24,5v2c1.654,0,3,1.346,3,3h2C29,7.243,26.757,5,24,5z" fill="none" stroke="#74b9ff" strokeWidth="1.2"/>
  </svg>
);