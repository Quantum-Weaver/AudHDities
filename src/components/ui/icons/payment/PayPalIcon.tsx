// src/app/components/ui/icons/payment/PayPalIcon.tsx
export const PayPalIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg"width="100%" height="120" viewBox="0 0 32 32" role="img" aria-label="PayPal">
    <defs>
      <linearGradient id="paypal-gradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#6c5ce7"/>
        <stop offset="50%" stopColor="#74b9ff"/>
        <stop offset="100%" stopColor="#00cec9"/>
      </linearGradient>
      <filter id="paypal-glow" x="-50%" y="-50%" width="200%" height="200%">
    ...
    <path 
      ...
      fill="url(#paypal-gradient)" 
      stroke="#00cec9" 
      strokeWidth="0.3" 
      filter="url(#paypal-glow)"
    />
  </svg>
);