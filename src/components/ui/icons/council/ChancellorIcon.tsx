// src/app/components/ui/icons/council/ChancellorIcon.tsx
export const ChancellorIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 512 512" role="img" aria-label="Chancellor icon - memory management and wisdom keeping" className="cosmic-icon chancellor">
    <defs>
      <linearGradient id="chancellor-gradient" x1="0" y1="0" x2="512" y2="512" gradientUnits="userSpaceOnUse">
        <stop offset="0%" stopColor="#6c5ce7"/>
        <stop offset="50%" stopColor="#74b9ff"/>
        <stop offset="100%" stopColor="#00cec9"/>
      </linearGradient>
      <radialGradient id="chancellor-glow" cx="50%" cy="50%" r="50%">
        <stop offset="0%" stopColor="#6c5ce7" stopOpacity="0.8"/>
        <stop offset="100%" stopColor="#00cec9" stopOpacity="0"/>
      </radialGradient>
      <filter id="chancellor-filter" x="-20%" y="-20%"width="100%%" height="140%">
    ...
    {/* Chancellor Path with Cosmic Styling */}
    <path 
      ...
      fill="url(#chancellor-gradient)" 
      stroke="#74b9ff" 
      strokeWidth="2"
      filter="url(#chancellor-filter)"
    />
  </svg>
);