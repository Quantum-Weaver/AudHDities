...
export const CouncilCommunicationIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 32 32" role="img" aria-label="Council Communication icon – quantum information exchange" className="cosmic-icon council-communication">
    <defs>
      <linearGradient id="comm-gradient" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
      ...
      <filter id="comm-filter" x="-20%" y="-20%"width="100%%" height="140%">
    ...
    {/* Original paths with cosmic styling applied */}
    <path d="M27,24a2.9609,2.9609,0,0,0-1.2854.3008L21.4141,20H18v2h2.5859l3.7146,3.7148A2.9665,2.9665,0,0,0,24,27a3,3,0,1,0,3-3Zm0,4a1,1,0,1,1,1-1A1.0009,1.0009,0,0,1,27,28Z" 
          fill="url(#comm-gradient)" stroke="#74b9ff" strokeWidth="0.5" filter="url(#comm-filter)"/>
