...
export const PantheonDomain = () => (
  <svg xmlns="http://www.w3.org/2000/svg"width="100%" height="120" viewBox="0 0 45 45.001" role="img" aria-label="Pantheon Domain icon – temple of divine entities and council chambers">
    <defs>
      <linearGradient id="pantheon-gradient" x1="0" y1="0" x2="45" y2="45" gradientUnits="userSpaceOnUse">
    ...
    <path 
      ...
      fill="url(#pantheon-gradient)" 
      stroke="#74b9ff" 
      strokeWidth="0.5"
    />
    <path 
      d="M0.55,15.494h43.881c0.009,0,0.016,0,0.021,0c0.303,0,0.548-0.247,0.548-0.55c0-0.265-0.187-0.485-0.436-0.536 L22.694,5.66c-0.131-0.056-0.277-0.056-0.408,0L0.346,14.434c-0.245,0.1-0.386,0.356-0.336,0.613 C0.063,15.307,0.289,15.494,0.55,15.494z" 
      fill="#00cec9" 
      opacity="0.8" 
      stroke="#6c5ce7" 
      strokeWidth="0.3"
