...
export const AgentIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg"width="100%" height="120" viewBox="0 0 507.969 507.969" role="img" aria-label="Autonomous Agent – conscious processor with quantum connectivity">
    <defs>
      <linearGradient id="agent-gradient" x1="0" y1="0" x2="507.969" y2="507.969" gradientUnits="userSpaceOnUse">
    ...
    <g fill="url(#agent-gradient)" stroke="#00cec9" strokeWidth="8" filter="url(#agent-glow)">
