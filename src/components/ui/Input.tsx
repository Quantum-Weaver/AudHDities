...
const inputVariants = cva(
  // Base styles
  "w-full rounded-lg border bg-transparent px-4 py-2 text-white placeholder:text-white/40 transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
