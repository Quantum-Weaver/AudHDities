...
import { HOUSE_WORDS_HREF } from '@/components/asgard/domains/aethelred/nexus/HouseWords';
import { HOUSE_WORDS_TAIL } from '@/lib/grammar/grammar-contract';

/** The room's house words, each linking to the page that tells them. */
