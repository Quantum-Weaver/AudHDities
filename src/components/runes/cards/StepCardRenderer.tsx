// src/components/runes/cards/StepCardRenderer.tsx
'use client';
...
import { getStepStatus, getStepProgress } from '@/lib/utils/components/runes/card.utils';
import type { CardData, StepCardData } from '@/types/components/runes/card.types';
