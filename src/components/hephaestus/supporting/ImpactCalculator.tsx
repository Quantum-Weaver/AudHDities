  ...
  return (
    <Card className={cn("p-6", className)}>
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-semibold text-white mb-1">Your Impact</h2>
        <p className="text-white/60 text-sm">See what your contribution makes possible</p>
      </div>
      ...
      {!hasAmount ? (
        ...
        <>
          <div className="mb-6 p-4 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-xl text-center">
            <div className="text-3xl font-bold text-cyan-400">${amount}</div>
            <div className="text-sm text-white/40 mt-1">Your offering</div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-white/10 text-center">
            ...
            <div className="text-xs text-white/40">Total impacts supported</div>
          </div>
