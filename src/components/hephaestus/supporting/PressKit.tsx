// src/components/hephaestus/supporting/PressKit.tsx
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {pressResources.map((resource) => {
          ...
          return (
            <Card key={resource.id} className="p-4 hover:border-cyan-500/30 transition-all">
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/40 mt-1">{resource.description}</p>
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      {resource.size && (
                        <span className="text-xs text-white/30">{resource.size}</span>
                      )}
                    </div>
                  </div>
                </div>
