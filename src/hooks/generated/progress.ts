...
export function useProgress(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/progress/${id}`);
...
export function useProgressList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/progress?${searchParams.toString()}`;
...
export function useCreateProgress() {
  ...
  const create = useCallback(async (data: ProgressInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/progress', {
        method: 'POST',
