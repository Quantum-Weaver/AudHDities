...
import type { ChannelsInsert, ChannelsRow, ChannelsUpdate } from '@/types/generated';
...
export function useChannels(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/hestia-core/channels/${id}`);
...
export function useChannelsList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/hestia-core/channels?${searchParams.toString()}`;
...
export function useCreateChannels() {
  ...
  const create = useCallback(async (data: ChannelsInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/hestia-core/channels', {
        method: 'POST',
