// =====================================================
// HOOKS: resonance
// GENERATED: 2026-07-10T18:14:59.760Z
// DEITY: hestia-core
// =====================================================

import { useState, useEffect, useCallback } from 'react';
import type { ResonanceRow, ResonanceInsert, ResonanceUpdate } from '@/types/generated/hestia-core/resonance';
...
export function useResonance(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/hestia-core/resonance/${id}`);
...
export function useResonanceList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/hestia-core/resonance?${searchParams.toString()}`;
...
export function useCreateResonance() {
  ...
  const create = useCallback(async (data: ResonanceInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/hestia-core/resonance', {
        method: 'POST',
