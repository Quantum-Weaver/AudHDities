...
/**
 * Hook to fetch a single progress record
 */
export function useProgress(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/athena-gamification/progress/${id}`);
...
/**
 * Hook to fetch a list of progress records with pagination
 */
export function useProgressList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/athena-gamification/progress?${searchParams.toString()}`;
...
export function useCreateProgress() {
  ...
  const create = useCallback(async (data: ProgressInsert) => {
    setLoading(true);
    setError(null);
    
    try {
      const response = await fetch('/api/generated/athena-gamification/progress', {
        method: 'POST',
...
export function useUpdateProgress() {
  ...
  const update = useCallback(async (id: string, data: ProgressUpdate) => {
    setLoading(true);
    setError(null);
