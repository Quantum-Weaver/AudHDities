...
/**
 * Hook to fetch a single prometheus_boundaries record
 */
export function usePrometheusBoundaries(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/prometheus_boundaries/${id}`);
...
/**
 * Hook to fetch a list of prometheus_boundaries records with pagination
 */
export function usePrometheusBoundariesList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/prometheus_boundaries?${searchParams.toString()}`;
...
/**
 * Hook to create a new prometheus_boundaries record
 */
export function useCreatePrometheusBoundaries() {
  ...
  const create = useCallback(async (data: PrometheusBoundariesInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/prometheus_boundaries', {
        method: 'POST',
...
/**
 * Hook to update a prometheus_boundaries record
 */
...
/**
 * Hook to delete a prometheus_boundaries record
 */
