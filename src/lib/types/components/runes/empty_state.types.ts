// src/types/components/runes/empty_state.types.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    EMPTY STATE TYPES                                      ║
// ║                    All type definitions for the EmptyState component      ║
// ╚═══════════════════════════════════════════════════════════════════════════╝

import type { EmptyStateSize } from '@/lib/constants/components/runes/empty_state.constants';
import type { EmptyStateVariant } from '@/lib/constants/components/runes/empty_state.variants';
