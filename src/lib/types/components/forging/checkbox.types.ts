// src/types/components/forging/checkbox.types.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    CHECKBOX TYPES                                         ║
...
import type {
  CheckboxVariant,
  CheckboxSizeVariant,
} from '@/lib/constants/components/forging/checkbox.variants';
import type { CheckboxSize } from '@/lib/constants/components/forging/checkbox.constants';
