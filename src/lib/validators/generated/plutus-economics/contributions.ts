...
export const ContributionsRowSchema = z.object({
  contribution_type: z.enum(ENUM_VALUES.contributionType),
  contributions_id: z.string(),
...
export const ContributionsInsertSchema = z.object({
  contribution_type: z.enum(ENUM_VALUES.contributionType),
  contributions_id: z.string().optional(),
  contributor_id: z.string(),
...
export const ContributionsUpdateSchema = z.object({
  contribution_type: z.enum(ENUM_VALUES.contributionType).optional(),
  contributions_id: z.string().optional(),
