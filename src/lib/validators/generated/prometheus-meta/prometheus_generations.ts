// =====================================================
// FILE: validators/prometheus_generations.ts
...
export const PrometheusGenerationsRowSchema = z.object({
  ...
  prometheus_generations_id: z.string(),
  session_id: z.string(),
  status: z.enum(ENUM_VALUES.generationStatus),
...
export const PrometheusGenerationsInsertSchema = z.object({
  ...
  prometheus_generations_id: z.string().optional(),
  session_id: z.string(),
  status: z.enum(ENUM_VALUES.generationStatus).optional(),
