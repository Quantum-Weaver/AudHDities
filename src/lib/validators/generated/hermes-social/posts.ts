...
export const PostsRowSchema = z.object({
  ...
  content_type: z.enum(ENUM_VALUES.contentType),
  ...
  visibility: z.enum(ENUM_VALUES.postVisibility),
});
...
export const PostsInsertSchema = z.object({
  ...
  visibility: z.enum(ENUM_VALUES.postVisibility).optional(),
});
