...
export const VesselConfigRowSchema = z.object({
  ...
  bubble_daily_max: z.number(),
  bubble_hourly_max: z.number(),
  ...
  environment_preference: z.string(),
  font_scale: z.number(),
...
export const VesselConfigInsertSchema = z.object({
  ...
  bubble_daily_max: z.number().optional(),
  bubble_hourly_max: z.number().optional(),
  ...
  environment_preference: z.string().optional(),
