...
export const VendorProfilesRowSchema = z.object({
  ...
  business_type: z.enum(ENUM_VALUES.businessType).nullable(),
...
export const VendorProfilesInsertSchema = z.object({
  ...
  business_name: z.string(),
  business_type: z.enum(ENUM_VALUES.businessType).nullable().optional(),
...
export const VendorProfilesUpdateSchema = z.object({
  business_description: z.string().nullable().optional(),
  business_logo_url: z.string().nullable().optional(),
  ...
  total_sales: z.number().nullable().optional(),
  updated_at: z.string().nullable().optional(),
  vendor_profiles_id: z.string().optional(),
  verified_at: z.string().nullable().optional(),
  verified_badge: z.boolean().nullable().optional(),
  verified_by: z.string().nullable().optional(),
  website_url: z.string().nullable().optional(),
...
export type VendorProfilesUpdateInput = z.infer<typeof VendorProfilesUpdateSchema>;
