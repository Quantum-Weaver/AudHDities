...
// =====================================================
// base: superposition · source: database.types.ts Constants.Enums · sha256 4459d24cf0e8
...
export const ENUM_VALUES = {
  ...
  applicationType: ['artisan', 'merchant', 'curator', 'council'] as const,
  ...
  userRole: ['community', 'artisan', 'merchant', 'curator', 'council', 'admin'] as const,
