...
import type { FunctionsRow, FunctionsInsert, FunctionsUpdate } from '../../../types/daedalus-meta/registries/functions';
...
export function useFunctions(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/daedalus-meta/registries/functions/${id}`);
...
export function useFunctionsList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/daedalus-meta/registries/functions?${searchParams.toString()}`;
...
export function useCreateFunctions() {
  ...
  const create = useCallback(async (data: FunctionsInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/daedalus-meta/registries/functions', {
        method: 'POST',
