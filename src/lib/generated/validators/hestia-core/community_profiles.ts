...
// schema_hash: 05708499ca38f01963d61fdc805ff3f1 · source sha256 130478f299af
...
export const CommunityProfilesRowSchema = z.object({
  ...
  council_house_id: z.string().nullable(),
  covenant_pledge_percent: z.number().nullable(),
  created_at: z.string(),
  created_by: z.string().nullable(),
  display_name: z.string(),
  exterior_url: z.string().nullable(),
  icon_emoji: z.string().nullable(),
  id: z.string(),
  roles: z.array(z.enum(ENUM_VALUES.userRole)),
...
export const CommunityProfilesInsertSchema = z.object({
  ...
  council_house_id: z.string().nullable().optional(),
  covenant_pledge_percent: z.number().nullable().optional(),
  created_at: z.string().optional(),
  created_by: z.string().nullable().optional(),
  display_name: z.string(),
  exterior_url: z.string().nullable().optional(),
  icon_emoji: z.string().nullable().optional(),
  id: z.string(),
  roles: z.array(z.enum(ENUM_VALUES.userRole)).optional(),
