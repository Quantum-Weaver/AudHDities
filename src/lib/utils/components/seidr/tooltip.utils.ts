// src/utils/components/seidr/tooltip.utils.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    TOOLTIP UTILITIES                                      ║
...
import type { TooltipSide } from '@/types/components/seidr/tooltip.types';
import type { TooltipPopupState } from '@/types/components/seidr/tooltip.types';
