// src/utils/components/vegvisir/tabs.utils.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    TABS UTILITIES                                         ║
...
import { tabsListVariants, tabsTriggerVariants, tabsPanelVariants } from '@/lib/constants/components/vegvisir/tabs.variants';
import {
  TABS_ORIENTATION,
  TABS_TRIGGER_VARIANT,
  TABS_SIZE,
} from '@/lib/constants/components/vegvisir/tabs.constants';
import type {
  TabsVariant,
  TabsSize,
  TabsOrientation,
