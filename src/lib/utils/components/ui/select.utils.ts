// src/utils/components/ui/select.utils.ts
// ╔═══════════════════════════════════════════════════════════════════════════╗
// ║                    SELECT UTILITIES                                       ║
...
import { selectVariants } from '@/lib/constants/components/ui/select.variants';
import {
  SELECT_LABEL_COLOR,
...
import type { SelectSizeVariant, SelectVariant } from '@/lib/constants/components/ui/select.variants';
