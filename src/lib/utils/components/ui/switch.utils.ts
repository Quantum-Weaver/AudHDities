...
import {
  switchTrackVariants,
  switchThumbVariants,
} from '@/lib/constants/components/ui/switch.variants';
import {
  SWITCH_LABEL_TEXT,
...
} from '@/lib/constants/components/ui/switch.constants';
import type { SwitchSize, SwitchVariant } from '@/lib/constants/components/ui/switch.variants';
