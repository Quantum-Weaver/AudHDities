...
export const BUTTON_VARIANT_CLASSES = {
  [BUTTON_VARIANTS_KEYS.PRIMARY]: {
    ...
    active: 'active:bg-quantum-dark active:scale-[0.98] motion-reduce:active:scale-100',
    disabled: 'disabled:bg-quantum-base/50 disabled:cursor-not-allowed',
  ...
  [BUTTON_VARIANTS_KEYS.SECONDARY]: {
    ...
    active: `active:bg-[${QUANTUM_COLORS['cosmic.dark']}] active:scale-[0.98] motion-reduce:active:scale-100`,
  ...
  [BUTTON_VARIANTS_KEYS.OUTLINE]: {
    ...
    active: 'active:bg-star-dust/20 active:scale-[0.98] motion-reduce:active:scale-100',
    disabled: 'disabled:border-star-dust/10 disabled:text-star-dust/40 disabled:cursor-not-allowed',
  },
  [BUTTON_VARIANTS_KEYS.GHOST]: {
    ...
    active: `active:bg-[${QUANTUM_COLORS['starDust']}]/20 active:scale-[0.98] motion-reduce:active:scale-100`,
  ...
  [BUTTON_VARIANTS_KEYS.DESTRUCTIVE]: {
    ...
    active: `active:bg-[${QUANTUM_COLORS['fire.dark']}] active:scale-[0.98] motion-reduce:active:scale-100`,
  ...
  [BUTTON_VARIANTS_KEYS.SUCCESS]: {
    ...
    active: `active:bg-[${QUANTUM_COLORS['library.dark']}] active:scale-[0.98] motion-reduce:active:scale-100`,
  ...
  [BUTTON_VARIANTS_KEYS.WARNING]: {
    ...
    active: `active:bg-[${QUANTUM_COLORS['hearth.orange']}] active:scale-[0.98] motion-reduce:active:scale-100`,
  ...
  [BUTTON_VARIANTS_KEYS.LINK]: {
    ...
    active: `active:scale-[0.98] motion-reduce:active:scale-100`,
