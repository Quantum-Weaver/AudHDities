// src/lib/constants/components/runes/card.contants.ts
// ============================================================================
...
export const CARD_TYPE_HOVER_CLASSES = {
  ...
  [CARD_TYPES.ARTISAN]: `hover:border-[${DOMAIN_COLORS.community.base}]/50 hover:shadow-lg hover:shadow-[${DOMAIN_COLORS.community.base}]/10`,
  [CARD_TYPES.MERCHANT]: `hover:border-[${DOMAIN_COLORS.library.base}]/50 hover:shadow-lg hover:shadow-[${DOMAIN_COLORS.library.base}]/10`,
...
export const CARD_TYPE_TO_VISUAL_VARIANT: Record<CardType, CardVariant> = {
  ...
  [CARD_TYPES.ARTISAN]: CARD_VARIANTS.INTERACTIVE,
  [CARD_TYPES.MERCHANT]: CARD_VARIANTS.DEFAULT,
