...
export const CONTINUITY_BEAM_VARIANTS = {
  // Memory Preservation Beam - Council/Library/Docs domains
  ...
  // Emotional Support Beam - Support/Contact/Community domains
  emotional_context: {
    // Visual Identity & Energy Signature
  ...
  // Cross-Domain Connection Beam - Council/Origin/Observatory domains
  quantum_entanglement: {
    ...
    holographic: {
      ...
      rainbow: HOLOGRAPHIC_EFFECTS.rainbow
    },
  ...
  // Home/Fantasy Beam - Home/Gateway/Learn/Seasonal domains
  hearth_beam: {
    // Visual Identity & Energy Signature
    ...
    animation: {
      ...
      pulse: {
        ...
        properties: {
          scale: [1, 1.15, 1],
          glow: [GLOW_EFFECTS['focus'], GLOW_EFFECTS['quantum'], GLOW_EFFECTS['focus']]
        }
      }
    },
  ...
  // Music/Creative Beam - Music/Timer domains
  creative_beam: {
    // Visual Identity & Energy Signature
    ...
    // Glow & Luminosity
    glow: {
      primary: GLOW_EFFECTS['hover'],
      secondary: GLOW_EFFECTS['active'],
      intensity: 'high' as const,
      spread: SPACING_SCALE['3'] // 12px
    },
  ...
  // Origin/Transformation Beam - Origin/Questionaire/Progress domains
  transformative_beam: {
    // Visual Identity & Energy Signature
    primary: QUANTUM_COLORS['energy.transformative'],
    secondary: QUANTUM_COLORS['success'],
    accent: QUANTUM_COLORS['mood.mystical'],
    ...
    glow: {
      primary: GLOW_EFFECTS['quantum'],
      secondary: GLOW_EFFECTS['focus'],
      intensity: 'quantum' as const,
      spread: SPACING_SCALE['6'] // 24px
    },
  ...
  // Observatory/Cosmic Beam - Observatory/About/Vision domains
  cosmic_beam: {
    // Visual Identity & Energy Signature
    primary: QUANTUM_COLORS['cosmic.blue'],
    secondary: QUANTUM_COLORS['info'],
