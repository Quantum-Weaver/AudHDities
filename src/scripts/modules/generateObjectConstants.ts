// src/scripts/modules/generateObjectConstants.ts
// Phase 10: Generate runtime enum constant files with staging

import * as fs from 'fs';
import * as path from 'path';
import { fileURLToPath } from 'url';
import type { FormattedConstantContent, GenerationResult } from '../shared/types.js';
 ...
 * Uses deity group mapping, falls back to 'hestia_core'
 */
