// src/scripts/modules/objectCheckList.ts
...
import type { ChecklistProgress, ExtractedObject, ObjectType } from '../shared/types.js';
import { logSuccess, logError, logInfo, logDebug, logWarning, logProgress } from '../shared/logger.js';
