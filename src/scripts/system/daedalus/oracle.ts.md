...
import { validate as validateJson } from '@/lib/daedalus/validator';
import { namingGuide } from '@/config/naming_guide';
import { GAIA_PATTERNS } from '@/config/gaia/patterns';

import type { Blueprint, BlueprintFile, BlueprintMetadata, SystemType } from '@/types/daedalus';
...
export class Oracle {
  ...
  constructor() {
    ...
    this.knownSystems = new Set(['COSMIC', 'GAIA', 'DAEDALUS']);
  ...
  validate(blueprint: Blueprint): ValidationResult {
    ...
    // TODO: Verify system is known (COSMIC | GAIA | DAEDALUS)
