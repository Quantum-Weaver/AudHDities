...
import { SENSITIVE_FIELDS, SensitiveField} from '@/config/sensitive_fields'
 ...
 */
export function formatMultipleTypes(
  ...
  for (const object of objects) {
    ...
    const formatted = formatTypes(object, category, options);
