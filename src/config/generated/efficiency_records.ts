// src/config/generated/efficiency_records.ts
// ============================================================================
...
const RECORDS_PATH = path.join(PROJECT_ROOT, 'src/config/generated/efficiency_records.ts');
...
function rewriteEntireFile(): void {
  ...
  const content = `// src/config/generated/efficiency_records.ts
// ============================================================================
// EFFICIENCY RECORDS - Performance tracking for COSMIC and GAIA
// ============================================================================
// ⚠️⚠️⚠️ AUTO-GENERATED DATA SECTION - Updated by COSMIC/GAIA ⚠️⚠️⚠️
