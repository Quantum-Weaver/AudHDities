...
export function useMaintenance(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/maintenance/${id}`);
...
export function useMaintenanceList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/maintenance?${searchParams.toString()}`;
...
export function useCreateMaintenance() {
  ...
  const create = useCallback(async (data: MaintenanceInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/maintenance', {
        method: 'POST',
