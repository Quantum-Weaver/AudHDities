...
export function useSupabaseConnection(id: string | undefined) {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`/api/generated/supabase_connection/${id}`);
...
export function useSupabaseConnectionList(params?: {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const url = `/api/generated/supabase_connection?${searchParams.toString()}`;
...
export function useCreateSupabaseConnection() {
  ...
  const create = useCallback(async (data: SupabaseConnectionInsert) => {
    ...
    try {
      const response = await fetch('/api/generated/supabase_connection', {
        method: 'POST',
